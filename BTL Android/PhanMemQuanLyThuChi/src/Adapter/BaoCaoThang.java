...
public class BaoCaoThang extends ArrayAdapter<BaoCao> {
	...
	public BaoCaoThang(Context context, int layoutResourceId, ArrayList<BaoCao> data, ArrayList<Integer> ImageId,
			ArrayList<String> title) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tiencon.setText(String.valueOf(Double.parseDouble(listData.get(position).getTienthu())
				- Double.parseDouble(listData.get(position).getTienchi())));
