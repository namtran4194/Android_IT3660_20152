 ...
 */
public class DongBacAdapter extends BaseAdapter {
    Context context;
    int layout;
    String []link;
    String []title;
    ...
    public DongBacAdapter(DongBacActivity dongBacActivity, int lvtaybac, String[] title, int[] detail, String[] link) {
        this.context=dongBacActivity;
        this.title=title;
        this.detail=detail;
        this.link=link;
