 ...
 */
public class TayNguyenAdapter extends BaseAdapter{
    Context context;
    int layout;
    String []link;
    String []title;
    int []detail;
    public TayNguyenAdapter(TayNguyenActivity tayNguyenActivity, int lvtaybac, String[] title, int[] detail, String[] link) {
        this.context=tayNguyenActivity;
        this.title=title;
        this.detail=detail;
        this.link=link;
