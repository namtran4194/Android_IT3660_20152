 ...
 */
public class NTBAdapter extends BaseAdapter{
    Context context;
    int layout;
    String []link;
    String []title;
    int []detail;
    public NTBAdapter(NamTrungBoActivity namTrungBoActivity, int lvtaybac, String[] title, int[] detail, String[] link) {
        this.context=namTrungBoActivity;
        this.title=title;
        this.detail=detail;
        this.link=link;
