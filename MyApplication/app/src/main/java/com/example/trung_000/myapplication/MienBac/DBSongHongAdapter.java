 ...
 */
public class DBSongHongAdapter extends BaseAdapter {
    Context context;
    int layout;
    String []link;
    String []title;
    int []detail;
    public DBSongHongAdapter(DBSongHongActivity dbSongHongActivity, int lvtaybac, String[] title, int[] detail, String[] link) {
        this.context=dbSongHongActivity;
        this.title=title;
        this.detail=detail;
        this.link=link;
