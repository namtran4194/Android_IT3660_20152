			...
			public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
				...
				b.setPositiveButton("Sửa", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						adapterthu = new ArrayAdapter<String>(DanhSachThuChi.this,
								android.R.layout.simple_spinner_dropdown_item, arrspinnerthu);
			...
			public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
				...
				b.setPositiveButton("Sửa", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						adapterchi = new ArrayAdapter<String>(DanhSachThuChi.this,
								android.R.layout.simple_spinner_dropdown_item, arrspinnerchi);
