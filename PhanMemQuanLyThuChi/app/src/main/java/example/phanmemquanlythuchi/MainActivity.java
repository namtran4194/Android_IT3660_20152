...
public class MainActivity extends Activity {
	...
	final static String[] mItemTexts = new String[] { "Thu nhập", "Chi tiêu", "Danh Sách", "Biều đồ", "Đổi tiền tệ",
			"Gửi tiết kiệm", "Thoát" };
	final static int[] mItemImgs = new int[] { R.drawable.icon_thu, R.drawable.icon_chi, R.drawable.icon_danh_sach,
			R.drawable.icon_bieu_do, R.drawable.icon_tien_te, R.drawable.icon_bank, R.drawable.icon_exit };
